...
{
    public class CreateOrderMessageConsumer : IConsumer<Messages.CreateOrderMessage>
    {
        ...
        public async Task Consume(ConsumeContext<Messages.CreateOrderMessage> context)
        {
