...
namespace IVCRM.DAL.Infrastructure
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<OrderItemEntity> ProductOrders { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItemEntity>().HasOne(x => x.Order).WithMany(x => x.ProductOrders).HasForeignKey(x => x.OrderId);
            modelBuilder.Entity<OrderItemEntity>().HasOne(x => x.Product).WithMany(x => x.ProductOrders).HasForeignKey(x => x.ProductId);
